...
<nav class="navbar navbar-expand-sm navbar-dark bg-primary" aria-label="Third navbar example">
  ...
  <div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        <h1 class="display-5 fw-bold text-body-emphasis lh-2 mb-3"><%=customExercise.getName() %></h1>
        <p class="lead"><%=customExercise.getDescription() %></p>

        <div class="d-grid  d-md-flex justify-content-md-start">
           <div class="d-flex py-5">
                 <span class="badge text-bg-info rounded-pill"><h4 class="card-text"><%= customExercise.getCategory().getName() %></h4></span>
            </div>
        </div>
    ...
    <a  href=<%= "showMyExercises.jsp" %>>
                       <button type="button" class="btn btn-primary align-items-right"> Back to my exercises</button>
                    </a>
  </div>
