 ...
 <div class="row">
  <div class="col">
       <div class="form-group " >
           ...
           <input type="text" class="form-control" name = "name" id="exerciseName" value=<%="\"" + customExercise.getName() + "\""%>>
         </div><br>

         <div class="form-group">
           <label for="exerciseCategory">Category</label>
           <select class="form-control" name = "category" id="exerciseCategory">
    ...
    <div class="form-group"">
      ...
      <input class="form-control" name="imagesource" id="exampleFormControlTextarea1" value=<%='"' + customExercise.getImageSource() + '"'%> rows="1"></textarea>
    </div>
    </div>
